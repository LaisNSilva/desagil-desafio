    ...
    public CpuPlayer(int row, int col, Board board) {
        ...
        for (int i = 0; i < numRows; i++) {
            for (int j = 0; j < numCols; j++) {
                ...
                // Todos os corredores devem ser inicializados como false,
                // pois ainda não foram visitados, e todas as paredes devem
                // ser inicializadas como true, pois não podem ser visitadas.
